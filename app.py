...
from evaluation.evaluate_with_online_check import evaluate_student_answer

app = Flask(__name__)

@app.route('/')
def home():
    return "✅ Theoretical Answer Evaluation System Running"
...
def evaluate():
    ...
    if not question or not student_answer:
        return jsonify({
            "error": "Missing question or student_answer in request."
        }), 400
    ...
    return jsonify({
        ...
        "online_reference": result.get("online_reference")
    })
